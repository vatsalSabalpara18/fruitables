                                                ...
                                                <tr key={cart_item?._id}>
                                                    <th scope="row">
                                                        <div className="d-flex align-items-center">
                                                            <img src={IMAGE_URL + cart_item?.product_img || "img/vegetable-item-3.png"} className="img-fluid me-5 rounded-circle" style={{ width: 80, height: 80 }} alt />
                                                        </div>
                                                    </th>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <p className="mb-0 mt-4">{cart_item?.price} $</p>
                                                    </td>
                                                    <td>
