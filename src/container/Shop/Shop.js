            ...
            <div className={theme}>
                ...
                <div className="container-fluid fruite py-5">
                    <div className="container py-5">
                        <h1 className="mb-4" style={{ color: theme === "light" ? '#45595b' : '#ffffff' }} >Fresh fruits shop</h1>
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-xl-3">
                                        <div className="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
                                            <label htmlFor="fruits" style={{ color: '#000000' }} >Default Sorting:</label>
                                            <select
                                                id="fruits"
                                                name="fruitlist"
                                ...
                                <div className="row g-4">
                                    <div className="col-lg-3">
                                        <div className="row g-4">
                                            <div className="col-lg-12">
                                                <div className="mb-3">
                                                    <h4 style={{ color: theme === "light" ? '#45595b' : '#ffffff' }} >Categories</h4>
                                                        ...
                                                        {categoryList?.map((item) => {
                                                            ...
                                                            return (
                                                                <li key={item?._id}>
                                                                    <div className="d-flex justify-content-between fruite-name">
                                                                        <span
                                                                            style={{ cursor: "pointer", color: theme === "light" ? '#45595b' : '#ffffff' }}
                                                                            className={
                                            ...
                                            <div className="col-lg-12">
                                                <div className="mb-3">
                                                    <h4 className="mb-2" style={{ color: theme === "light" ? '#45595b' : '#ffffff' }}>Price</h4>
                                                    {/* <input
                                                        type="range"
                                                        ...
                                                        <NavLink to={`/shop_detail/${product_Item?._id}`}>
                                                            <div className="rounded position-relative fruite-item">
                                                                ...
                                                                <div
                                                                    ...
                                                                    style={{ top: 10, left: 10, color: theme === "light" ? '#45595b' : '#ffffff' }}
                                                                >
                                                                    {subCategoryName}
                                                                </div>
                                                                <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                                    <h4 style={{ color: theme === "light" ? '#45595b' : '#ffffff' }} >{product_Item?.name}</h4>
                                                                    <p>
                                                                        {product_Item?.description?.slice(0, 70)}...
                                                                    </p>
                                                                    <div className="d-flex justify-content-between flex-lg-wrap">
                                                                        <span className="text-dark fs-5 fw-bold mb-0" style={{ color: theme === "light" ? '#45595b' : '#ffffff' }}>
                                                                            $ {product_Item?.price}
                                                                        </span>
                                                                        <a
                                                                            href="#"
